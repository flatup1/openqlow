...
export const FLATUP_CANON = {
  ...
  // オーナー確定（2026-07-13 更新）。会員のセルフ利用とスタッフ在館時間を区別する。夜は21:00まで、土曜は10:00〜15:00に訂正。
  businessHours:
    "会員はカードキーで24時間セルフ利用可。スタッフ在館は平日10:00〜12:00・18:00〜21:00、土曜10:00〜15:00、日曜・祝日休（体験・見学はスタッフ在館時間のみ）",
  selfAccess: "会員はカードキーで24時間セルフ利用可（体験・見学は対象外）",
  cancellation:
    "退会は当月末日までの申請で翌月末退会（即日不可）。キャンペーン適用で入会し、1年未満で退会する場合は入会金相当10,000円が発生する可能性があります。詳細は契約内容を確認。正本は cancellation_rules.md",
