...
export const FLATUP_CANON = {
  ...
  // オーナー確定（2026-07-03更新）。AIはこの値だけを案内し、推測で変えない。
  businessHours: "平日10:00〜12:00・18:00〜21:00、土曜はクラス制、日曜・祝日休",
  trialReceptionHours: "平日夜の体験受付は18:00〜20:00まで（21:00まで通常クラス継続）",
  classes:
