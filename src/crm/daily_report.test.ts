...
// 日報は短く、返信文は載せず `crm draft <id>` へ誘導する
assert(markdown.includes("crm draft"), "report points to crm draft for reply text");
assert(!markdown.includes("お問い合わせありがとうございます"), "long reply drafts are NOT inlined in the report");
