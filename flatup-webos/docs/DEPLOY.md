...
- **公開URLが決まったら、`index.html` の2行を絶対URLへ直す**（LINEやSNSでシェアされた時に
  カード画像とタイトルが出るようにするため）。
  ```html
  <meta property="og:image" content="https://<ドメイン>/webos/hero.jpg">
  <meta property="og:url"   content="https://<ドメイン>/webos/">
  ```
  （`og:url` はまだ入れていない。公開パス確定後に1行足すだけでよい）
