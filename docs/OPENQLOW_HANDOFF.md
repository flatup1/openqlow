# FLATUPGYM / OPENQLOW / LINE BOT 引き継ぎ（要約版）

> ⚠️ **正本はここではありません。** 同じ名前の書類が2つあり、混乱の元になっていたため関係を明記します（2026-08-21）。
>
> | ファイル | 位置づけ |
> |---|---|
> | **`/OPENQLOW_HANDOFF.md`（リポジトリ直下・v3）** | **正本**。README が指しているのもこちら。分量が多く、最新 |
> | `/docs/OPENQLOW_HANDOFF.md`（このファイル） | 要約版。思想と全体像を短く読みたいときの入口 |
>
> **矛盾したら直下の v3 を優先**してください。全体の地図は [`SYSTEM_BLUEPRINT.md`](SYSTEM_BLUEPRINT.md) です。
